        ...
        <div className=" mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16 ">
          ...
          <div className="mb-6 grid gap-8 lg:mb-16">
            ...
            <div className="items-center rounded-lg bg-gray-50 shadow dark:border-gray-700 dark:bg-gray-800 sm:flex">
              <a href="#">
                <img
                  className="h-64 w-full rounded-lg object-cover sm:max-h-48 sm:w-64 sm:rounded-none sm:rounded-l-lg"
                  src="/images/eden.png"
                  alt="Logo Eden #10"
                />
              </a>
              <div className="p-5">
                ...
                <div className="mb-4 flex gap-4">
                  <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
                    ...
                    <span className="text-base">13 de octubre</span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
                    <svg
                      className="h-4 w-4"
                    ...
                    <span className="text-base">7:00 PM</span>
                  </div>
                </div>
                <ul className="flex items-center space-x-4 sm:mt-0">
                  ...
                  <li>
                    <a
                      href="https://maps.app.goo.gl/YW5HBAa8qF16eFJf8"
                      target="_blank"
